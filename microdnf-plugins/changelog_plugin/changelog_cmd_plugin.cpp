...
APIVersion microdnf_plugin_get_api_version(void) {
...
PluginVersion microdnf_plugin_get_version(void) {
    return PLUGIN_VERSION;
}

IPlugin * microdnf_plugin_new_instance([[maybe_unused]] APIVersion api_version) try {
    return new ChangelogCmdPlugin;
} catch (...) {
    return nullptr;
}

void microdnf_plugin_delete_instance(IPlugin * plugin_object) {
