...
#ifndef MICRODNF_PLUGIN_PLUGINS_HPP
#define MICRODNF_PLUGIN_PLUGINS_HPP
...
public:
    ...
    void init(microdnf::Context * context) {
        if (iplugin_instance) {
...
class Plugins {
public:
    Plugins(microdnf::Context & context) : context(&context) {}
    ~Plugins();
