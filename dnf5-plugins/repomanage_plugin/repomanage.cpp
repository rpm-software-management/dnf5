...
void RepomanageCommand::load_additional_packages() {
    ...
    if (!repo_with_repodata) {
        ...
        get_context().get_base().get_repo_sack()->add_cmdline_packages(found_rpms);
    }
}
