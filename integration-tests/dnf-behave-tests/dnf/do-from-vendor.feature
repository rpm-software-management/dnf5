...
Scenario: Reinstall vendorapp2 from "Second Vendor" and downgrade vendorapp from "First Vendor" (--allow-vendor-change)
  Given I use repository "dnf-ci-vendor-1-updates"
   ...
   When I execute dnf with args "do --action=reinstall --allow-vendor-change --from-vendor='Second\ Vendor' vendorapp2 --action=downgrade --from-vendor='First\ Vendor' vendorapp"
   Then the exit code is 0
    And Transaction is following
        | Action    | Package                   |
...
Scenario: Reinstall vendorapp2 from "Second Vendor" and downgrade vendorapp from "First Vendor" (--setopt=allow_vendor_change=1)
  Given I use repository "dnf-ci-vendor-1-updates"
    And I use repository "dnf-ci-vendor-2-updates"
    And I use repository "dnf-ci-vendor-3-updates"
...
Scenario: Reinstall vendorapp2 from "Second Vendor" and downgrade vendorapp from "First Vendor" fails (--no-allow-vendor-change)
  Given I use repository "dnf-ci-vendor-1-updates"
    And I use repository "dnf-ci-vendor-2-updates"
    And I use repository "dnf-ci-vendor-3-updates"
   When I execute dnf with args "do --action=reinstall --no-allow-vendor-change --from-vendor='Second\ Vendor' vendorapp2 --action=downgrade --from-vendor='First\ Vendor' vendorapp"
...
Scenario: Reinstall vendorapp2 from "Second Vendor" and downgrade vendorapp from "First Vendor" fails (--setopt=allow_vendor_change=0)
  Given I use repository "dnf-ci-vendor-1-updates"
    And I use repository "dnf-ci-vendor-2-updates"
    And I use repository "dnf-ci-vendor-3-updates"
