...
Provides:       nodejs = 1:12.1.0-1.module_2379+8d497405
Provides:       nodejs(x86-64) = 1:12.1.0-1.module_2379+8d497405
Provides:       bundled(icu) = 63.1
Provides:       bundled(v8) = 7.0.276.32
Provides:       nodejs(abi) = 12.1
Provides:       nodejs(abi11) = 12.1
Provides:       nodejs(engine) = 12.1.0
...
Recommends:     npm = 1:6.4.1-1.12.1.0.1.module_2379+8d497405
...
Provides:       nodejs-devel = 1:12.1.0-1.module_2379+8d497405
Provides:       nodejs-devel(x86-64) = 1:12.1.0-1.module_2379+8d497405

Requires:       rtld(GNU_HASH)
Requires:       nodejs(x86-64) = 1:12.1.0-1.module_2379+8d497405
...
Provides:       nodejs-docs = 1:12.1.0-1.module_2379+8d497405

Conflicts:      nodejs < 1:12.1.0-1.module_2379+8d497405
Conflicts:      nodejs > 1:12.1.0-1.module_2379+8d497405
...
Provides:       bundled(nodejs-brace-expansion) = 1.1.12
...
Provides:       bundled(nodejs-cacache) = 12.2.0
...
Provides:       bundled(nodejs-config-chain) = 1.1.12
...
Provides:       bundled(nodejs-npm-packlist) = 1.1.12
...
Provides:       bundled(nodejs-yargs) = 12.0.0
Provides:       bundled(nodejs-yargs-parser) = 9.0.2
Provides:       npm = 1:6.4.1-1.12.1.0.1.module_2379+8d497405
Provides:       npm(x86-64) = 1:6.4.1-1.12.1.0.1.module_2379+8d497405

Requires:       nodejs = 1:12.1.0-1.module_2379+8d497405
