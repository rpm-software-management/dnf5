...
Epoch:          1
Version:        10.14.1
Release:        1.module_2533+7361f245
...
Provides:       nodejs = 1:10.14.1-1.module_2533+7361f245
Provides:       nodejs(x86-64) = 1:10.14.1-1.module_2533+7361f245
Provides:       bundled(icu) = 62.1
Provides:       bundled(v8) = 6.8.275.32
Provides:       nodejs(v8-abi) = 6.8
Provides:       nodejs(v8-abi6) = 6.8
Provides:       nodejs(abi) = 10.14
Provides:       nodejs(abi10) = 10.14
Provides:       nodejs(engine) = 10.14.1

Requires:       rtld(GNU_HASH)

Conflicts:      node <= 0.3.2-12

Recommends:     npm = 1:6.4.1-1.10.14.1.1.module_2533+7361f245
...
Provides:       nodejs-devel = 1:10.14.1-1.module_2533+7361f245
Provides:       nodejs-devel(x86-64) = 1:10.14.1-1.module_2533+7361f245

Requires:       rtld(GNU_HASH)
Requires:       nodejs(x86-64) = 1:10.14.1-1.module_2533+7361f245
...
Provides:       nodejs-docs = 1:10.14.1-1.module_2533+7361f245

Conflicts:      nodejs < 1:10.14.1-1.module_2533+7361f245
Conflicts:      nodejs > 1:10.14.1-1.module_2533+7361f245
...
Provides:       npm = 1:6.4.1-1.10.14.1.1.module_2533+7361f245
Provides:       npm(x86-64) = 1:6.4.1-1.10.14.1.1.module_2533+7361f245

Requires:       nodejs = 1:10.14.1-1.module_2533+7361f245
